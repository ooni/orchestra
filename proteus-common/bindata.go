...
func dataMigrations4_rendezvous_tablesSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/migrations/4_rendezvous_tables.sql", size: 2129, mode: os.FileMode(420), modTime: time.Unix(1512737144, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
