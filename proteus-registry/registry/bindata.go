...
func dataMigrations1_accounts_createSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/migrations/1_accounts_create.sql", size: 627, mode: os.FileMode(420), modTime: time.Unix(1501274911, 0)}
...
func dataMigrations1_active_probes_createSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/migrations/1_active_probes_create.sql", size: 665, mode: os.FileMode(420), modTime: time.Unix(1501274911, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataMigrations1_probe_updates_createSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/migrations/1_probe_updates_create.sql", size: 580, mode: os.FileMode(420), modTime: time.Unix(1501274911, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataMigrations2_add_language_columnSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/migrations/2_add_language_column.sql", size: 766, mode: os.FileMode(420), modTime: time.Unix(1501677275, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
