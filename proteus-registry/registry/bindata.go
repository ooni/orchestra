...
func dataTemplatesHomeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/templates/home.tmpl", size: 1378, mode: os.FileMode(420), modTime: time.Unix(1501274911, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"data": {nil, map[string]*bintree{
		"templates": {nil, map[string]*bintree{
			"home.tmpl": {dataTemplatesHomeTmpl, map[string]*bintree{}},
		}},
	}},
