...
var _bindataRegistryDataTemplatesHometmpl = []byte(
...
func bindataRegistryDataTemplatesHometmplBytes() ([]byte, error) {
	return bindataRead(
		_bindataRegistryDataTemplatesHometmpl,
		"registry/data/templates/home.tmpl",
	)
}
...
func bindataRegistryDataTemplatesHometmpl() (*asset, error) {
	bytes, err := bindataRegistryDataTemplatesHometmplBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{
		name: "registry/data/templates/home.tmpl",
		size: 0,
		md5checksum: "",
		mode: os.FileMode(0),
		modTime: time.Unix(0, 0),
...
var _bindata = map[string]func() (*asset, error){
	...
	"registry/data/templates/home.tmpl":                 bindataRegistryDataTemplatesHometmpl,
}
...
var _bintree = &bintree{Func: nil, Children: map[string]*bintree{
	...
	"registry": {Func: nil, Children: map[string]*bintree{
		"data": {Func: nil, Children: map[string]*bintree{
			"templates": {Func: nil, Children: map[string]*bintree{
				"home.tmpl": {Func: bindataRegistryDataTemplatesHometmpl, Children: map[string]*bintree{}},
			}},
		}},
	}},
}}
